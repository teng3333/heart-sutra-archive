...
(function () {
  ...
  /* 記憶の鍵を変えた(2026-09-20 高尾さん指摘)。
     旧 'ogs-bgm' は、最初の操作で勝手に鳴り始めたときにも 'on' を書き込んでいた。
     つまり残っている 'on' は、本人が選んだ印ではない。
     それを「一度ONにした人」として扱うと、選んでいない人に鳴り続ける。
     鍵を新しくして、旧い値は引き継がない。全員が無音から始まり、
     釦を押した人だけが 'on' を持つ。 */
  var KEY = 'ogs-bgm-v2';       // 'on' | 'off'。押した人だけが持つ
